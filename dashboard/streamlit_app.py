...
all_df = pd.read_csv("https://raw.githubusercontent.com/HiiGER/Final/refs/heads/master/data/all_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv("https://raw.githubusercontent.com/HiiGER/Final/refs/heads/master/data/geolocation.csv")
